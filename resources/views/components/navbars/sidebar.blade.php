    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @if (auth()->user()->roles->contains('name', 'ADMIN') || auth()->user()->roles->contains('name', 'HRD'))
                <li class="nav-item">
                    <a class="nav-link text-white {{ $activePage == 'data-master' ? ' active bg-gradient-primary' : '' }}"
                    ...
                    <div class="collapse" id="submenuForm">
                        <ul class="nav ms-4">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white {{ $activePage == 'bagian' ? 'active bg-gradient-primary' : '' }}"
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white {{ $activePage == 'unit' ? 'active bg-gradient-primary' : '' }}"
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white {{ $activePage == 'libur' ? 'active bg-gradient-primary' : '' }}"
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white {{ $activePage == 'datastockcuti' ? 'active bg-gradient-primary' : '' }}"
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white {{ $activePage == 'peraturan' ? 'active bg-gradient-primary' : '' }}"
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white {{ $activePage == 'informasi' ? 'active bg-gradient-primary' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'kalender' ? ' active bg-gradient-primary' : '' }}"
                ...
                <div class="collapse" id="submenuForm3">
                    <ul class="nav ms-4">
                        ...
                        @endif
                        <li class="nav-item">
                            <a class="nav-link text-white {{ $activePage == 'hari-libur' ? ' active bg-gradient-primary' : '' }}  "
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'peraturanview' ? ' active bg-gradient-primary' : '' }}  "
