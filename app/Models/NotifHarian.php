...
class NotifHarian extends Model
{
    use HasFactory;
    protected $table = 'notif_harian';  // Menentukan nama tabel yang digunakan oleh model
    protected $fillable = ['tanggal', 'karyawan', 'dt', 'baca', 'waktu'];  // Kolom yang dapat diisi secara massal
